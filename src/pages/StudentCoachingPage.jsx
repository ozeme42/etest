...
export default function StudentCoachingPage() {
  ...
  const { generalTrialExams, otherHomeworkSubmissions } = useMemo(() => {
    const normalizeSub = (s, parentHw, defaultType = 'online') => {
      ...
      let subject = s.subject || parentHw?.subject || '';
              ...
              <div>
                ...
                {(() => {
                  ...
                  const SUBJECT_COLORS = {
                    'Matematik': { text: '#2563eb', bg: '#eff6ff', border: '#bfdbfe' },
                    'Türkçe': { text: '#d97706', bg: '#fffbeb', border: '#fde68a' },
                    'Fen Bilimleri': { text: '#059669', bg: '#f0fdf4', border: '#bbf7d0' },
                    'Sosyal Bilgiler': { text: '#dc2626', bg: '#fef2f2', border: '#fecaca' },
                    'İngilizce': { text: '#7c3aed', bg: '#f5f3ff', border: '#ddd6fe' },
                    'Din Kültürü': { text: '#0891b2', bg: '#ecfeff', border: '#a5f3fc' },
                    'Genel / Diğer': { text: '#475569', bg: '#f8fafc', border: '#e2e8f0' }
                  };
                  ...
                  return (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 10, padding: '0.75rem 0.9rem', background: '#f8fafc', borderRadius: '0.9rem', border: '1.5px solid #e2e8f0' }}>
                        {/* Görünüm Modu Seçici (Derslere Göre / Günlere Göre) */}
                        <div style={{ display: 'flex', gap: 6, background: '#e2e8f0', padding: 3, borderRadius: '0.65rem' }}>
                          <button
                            type="button"
                      ...
                      {currentEntries.length === 0 ? (
                        <div style={{ textAlign: 'center', color: '#94a3b8', padding: '2rem', fontWeight: 600, background: '#f8fafc', borderRadius: '0.85rem', border: '1px dashed #cbd5e1' }}>
                          ...
                          {hwGroupByMode === 'subject' && currentEntries.map(([subjName, tests]) => {
                            ...
                            return (
                              <div key={subjName} style={{ background: 'white', borderRadius: '1rem', border: `1.5px solid ${col.border}`, overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.03)' }}>
                                ...
                                {isOpen && (
                                  <div style={{ padding: '0.85rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '0.75rem', background: '#fafbfc' }}>
                                    {tests.map((s, i) => {
                              ...
                              >
                                ...
                                <div
                                  ...
                                  style={{
                                    ...
                                    gap: 8,
                                    padding: '0.75rem 1rem',
                                    background: isBugun ? '#f0fdf4' : '#f8fafc',
                                    cursor: 'pointer',
                                ...
                                >
                                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, flexWrap: 'wrap' }}>
                                    ...
                                    <span style={{ fontSize: '0.72rem', fontWeight: 800, color: '#2563eb', background: '#eff6ff', border: '1px solid #bfdbfe', padding: '1px 8px', borderRadius: 99 }}>
                                      {tests.length} Test
                                    </span>
                                    <span style={{ fontSize: '0.72rem', fontWeight: 900, color: '#7c3aed', background: '#f5f3ff', border: '1px solid #ddd6fe', padding: '1px 8px', borderRadius: 99 }}>
