                ...
                {(() => {
                  ...
                  return (
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                      ...
                      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 8, padding: '0.65rem 0.85rem', background: '#f8fafc', borderRadius: '0.85rem', border: '1px solid #e2e8f0' }}>
