                    ...
                    {user.role === 'student' ? (() => {
                      ...
                      return (
                        <select
                          ...
                          style={{ padding: '0.3rem 0.5rem', borderRadius: '0.5rem', border: '1px solid #cbd5e1', fontSize: '0.78rem', background: currentGradeVal ? '#eff6ff' : '#fffef0', color: currentGradeVal ? '#1d4ed8' : '#b45309', fontWeight: 700, cursor: 'pointer' }}
                        >
