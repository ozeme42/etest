...
export default function StudentResultsPage({ studentId: propStudentId, onBack, embedded = false }) {
  ...
  /* ── Build studentSubmissions (Single Source of Truth via Unified Result Adapter) ─── */
  const studentSubmissions = useMemo(() => {
    const currentTargetStudent = selectedStudent || effectiveStudent;
    if (!currentTargetStudent?.id) return [];
  ...
  }, [selectedStudent, effectiveStudent, submissions, homeworks, books, bookTests, generalTrialExams]);
