    ...
    try {
      ...
      if (isRemedial && addHomework) {
        savedHw = await addHomework({
          ...
          isRemedial: true,
          isRemedialTest: true,
          isTeacherRemedial: currentUser?.role !== 'student',
          teacherAssigned: currentUser?.role !== 'student',
          isSelfCreated: currentUser?.role === 'student',
          createdBy: currentUser?.id || finalStudentId,
          createdByRole: currentUser?.role === 'student' ? 'student' : 'teacher',
          assignedBy: currentUser?.role === 'student' ? 'student' : 'teacher',
          teacherId: currentUser?.role !== 'student' ? currentUser?.id : null,
          assignedTeacherId: currentUser?.role !== 'student' ? currentUser?.id : null,
