                    ...
                    <div style={{ marginTop: '0.75rem', display: 'flex', flexDirection: 'column', gap: 6 }}>
                      <div style={{ display: 'flex', gap: 6 }}>
                        <button
                          ...
                          style={{ flex: 1, padding: '0.35rem', borderRadius: 6, border: currentScore === 10 ? '2px solid #16a34a' : '1px solid #cbd5e1', background: currentScore === 10 ? '#16a34a' : '#ffffff', color: currentScore === 10 ? '#ffffff' : '#15803d', fontWeight: 900, fontSize: '0.75rem', cursor: 'pointer' }}
                        >
                          ✓ 10 Puan
                        </button>
                        <button
                          ...
                          style={{ flex: 1, padding: '0.35rem', borderRadius: 6, border: currentScore === 5 ? '2px solid #d97706' : '1px solid #cbd5e1', background: currentScore === 5 ? '#d97706' : '#ffffff', color: currentScore === 5 ? '#ffffff' : '#d97706', fontWeight: 900, fontSize: '0.75rem', cursor: 'pointer' }}
                        >
                          ½ 5 Puan
                        </button>
                        <button
                          ...
                          style={{ flex: 1, padding: '0.35rem', borderRadius: 6, border: currentScore === 0 ? '2px solid #dc2626' : '1px solid #cbd5e1', background: currentScore === 0 ? '#dc2626' : '#ffffff', color: currentScore === 0 ? '#ffffff' : '#b91c1c', fontWeight: 900, fontSize: '0.75rem', cursor: 'pointer' }}
                        >
                          ✕ 0 Puan
                        </button>
                      </div>
