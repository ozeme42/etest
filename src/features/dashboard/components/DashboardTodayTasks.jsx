                    ...
                    >
                      ...
                      {task.done ? (
                        ...
                        <button
                          ...
                          style={{
                            background: (task.hasPastAttempt || task.isRetake || task.isSolved || task.pastAttemptCount > 0 || (task.stage && task.stage > 1))
                        ...
                        >
                          {(task.hasPastAttempt || task.isRetake || task.isSolved || task.pastAttemptCount > 0 || (detectedStage && detectedStage > 1)) ? (
                            <>
                              <RotateCcw size={14} /> {detectedStage ? `${detectedStage}. Kez Çöz` : 'Tekrar Çöz'}
                            </>
                          ) : (
                            <>
