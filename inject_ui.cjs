...
// 1. Add Manuel Sonuç Ekle Button
...
if (!code.includes('MANUAL MOCK MODAL')) {
  code = code.replace(
    /{isAddModalOpen && \(/,
    modalHTML + '\n      {isAddModalOpen && ('
  );
